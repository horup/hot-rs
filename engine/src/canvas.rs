use shared::{CanvasOrg, Context};
use macroquad::prelude::*;
use crate::MacroquadEngine;

impl CanvasOrg for MacroquadEngine {
    fn draw_string(&mut self, p:shared::DrawStringParams) {
        draw_text_ex(&p.str, p.x, p.y, TextParams {
            ..Default::default()
        });
    }

    fn draw_texture(&mut self, p:shared::DrawTextureParams) {
    ...
    fn draw_rect(&mut self, params:shared::DrawRectParams) {
